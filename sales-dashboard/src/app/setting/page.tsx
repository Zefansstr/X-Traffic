...
export default function SettingPage() {
  const settingMenus = [
    ...
    },
    {
      ...
      description: 'Manage commission rates based on staff position',
      href: '/setting/commission-rates',
    ...
    },
    {
      ...
      description: 'Manage currency exchange rates for multi-currency',
      href: '/setting/exchange-rates',
